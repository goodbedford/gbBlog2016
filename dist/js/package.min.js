...
return new d(this,a)},b.module("ui.router.util").provider("$urlMatcherFactory",t),b.module("ui.router.util").run(["$urlMatcherFactory",function(a){}]),u.$inject=["$locationProvider","$urlMatcherFactoryProvider"],b.module("ui.router.router").provider("$urlRouter",u),v.$inject=["$urlRouterProvider","$urlMatcherFactoryProvider"],b.module("ui.router.state").value("$stateParams",{}).provider("$state",v),w.$inject=[],b.module("ui.router.state").provider("$view",w),b.module("ui.router.state").provider("$uiViewScroll",x),y.$inject=["$state","$injector","$uiViewScroll","$interpolate"],z.$inject=["$compile","$controller","$state","$interpolate"],b.module("ui.router.state").directive("uiView",y),b.module("ui.router.state").directive("uiView",z),D.$inject=["$state","$timeout"],E.$inject=["$state","$stateParams","$interpolate"],b.module("ui.router.state").directive("uiSref",D).directive("uiSrefActive",E).directive("uiSrefActiveEq",E),F.$inject=["$state"],G.$inject=["$state"],b.module("ui.router.state").filter("isState",F).filter("includedByState",G)}(window,window.angular),function(a,b,c){"use strict";function d(){var a=!1;this.$get=["$$sanitizeUri",function(c){return a&&b.extend(x,v),function(a){var b=[];return g(a,j(b,function(a,b){return!/^unsafe:/.test(c(a,b))})),b.join("")}}],this.enableSvg=function(c){return b.isDefined(c)?(a=c,this):a}}function e(a){var c=[],d=j(c,b.noop);return d.chars(a),c.join("")}function f(a,c){var d,e={},f=a.split(",");for(d=0;d<f.length;d++)e[c?b.lowercase(f[d]):f[d]]=!0;return e}function g(a,b){null===a||a===c?a="":"string"!=typeof a&&(a=""+a),l.innerHTML=a;var d=5;do{if(0===d)throw m("uinput","Failed to sanitize html because the input is unstable");d--,document.documentMode<=11&&k(l),a=l.innerHTML,l.innerHTML=a}while(a!==l.innerHTML);for(var e=l.firstChild;e;){switch(e.nodeType){case 1:b.start(e.nodeName.toLowerCase(),h(e.attributes));break;case 3:b.chars(e.textContent)}var f;if(!(f=e.firstChild)&&(1==e.nodeType&&b.end(e.nodeName.toLowerCase()),f=e.nextSibling,!f))for(;null==f&&(e=e.parentNode,e!==l);)f=e.nextSibling,1==e.nodeType&&b.end(e.nodeName.toLowerCase());e=f}for(;e=l.firstChild;)l.removeChild(e)}function h(a){for(var b={},c=0,d=a.length;d>c;c++){var e=a[c];b[e.name]=e.value}return b}function i(a){return a.replace(/&/g,"&amp;").replace(n,function(a){var b=a.charCodeAt(0),c=a.charCodeAt(1);return"&#"+(1024*(b-55296)+(c-56320)+65536)+";"}).replace(o,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function j(a,c){var d=!1,e=b.bind(a,a.push);return{start:function(a,f){a=b.lowercase(a),!d&&w[a]&&(d=a),d||x[a]!==!0||(e("<"),e(a),b.forEach(f,function(d,f){var g=b.lowercase(f),h="img"===a&&"src"===g||"background"===g;B[g]!==!0||y[g]===!0&&!c(d,h)||(e(" "),e(f),e('="'),e(i(d)),e('"'))}),e(">"))},end:function(a){a=b.lowercase(a),d||x[a]!==!0||p[a]===!0||(e("</"),e(a),e(">")),a==d&&(d=!1)},chars:function(a){d||e(i(a))}}}function k(a){if(a.nodeType===Node.ELEMENT_NODE)for(var b=a.attributes,c=0,d=b.length;d>c;c++){var e=b[c],f=e.name.toLowerCase();("xmlns:ns1"===f||0===f.indexOf("ns1:"))&&(a.removeAttributeNode(e),c--,d--)}var g=a.firstChild;g&&k(g),g=a.nextSibling,g&&k(g)}var l,m=b.$$minErr("$sanitize"),n=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,o=/([^\#-~ |!])/g,p=f("area,br,col,hr,img,wbr"),q=f("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),r=f("rp,rt"),s=b.extend({},r,q),t=b.extend({},q,f("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,section,table,ul")),u=b.extend({},r,f("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),v=f("circle,defs,desc,ellipse,font-face,font-face-name,font-face-src,g,glyph,hkern,image,linearGradient,line,marker,metadata,missing-glyph,mpath,path,polygon,polyline,radialGradient,rect,stop,svg,switch,text,title,tspan"),w=f("script,style"),x=b.extend({},p,t,u,s),y=f("background,cite,href,longdesc,src,xlink:href"),z=f("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,tabindex,target,title,type,valign,value,vspace,width"),A=f("accent-height,accumulate,additive,alphabetic,arabic-form,ascent,baseProfile,bbox,begin,by,calcMode,cap-height,class,color,color-rendering,content,cx,cy,d,dx,dy,descent,display,dur,end,fill,fill-rule,font-family,font-size,font-stretch,font-style,font-variant,font-weight,from,fx,fy,g1,g2,glyph-name,gradientUnits,hanging,height,horiz-adv-x,horiz-origin-x,ideographic,k,keyPoints,keySplines,keyTimes,lang,marker-end,marker-mid,marker-start,markerHeight,markerUnits,markerWidth,mathematical,max,min,offset,opacity,orient,origin,overline-position,overline-thickness,panose-1,path,pathLength,points,preserveAspectRatio,r,refX,refY,repeatCount,repeatDur,requiredExtensions,requiredFeatures,restart,rotate,rx,ry,slope,stemh,stemv,stop-color,stop-opacity,strikethrough-position,strikethrough-thickness,stroke,stroke-dasharray,stroke-dashoffset,stroke-linecap,stroke-linejoin,stroke-miterlimit,stroke-opacity,stroke-width,systemLanguage,target,text-anchor,to,transform,type,u1,u2,underline-position,underline-thickness,unicode,unicode-range,units-per-em,values,version,viewBox,visibility,width,widths,x,x-height,x1,x2,xlink:actuate,xlink:arcrole,xlink:role,xlink:show,xlink:title,xlink:type,xml:base,xml:lang,xml:space,xmlns,xmlns:xlink,y,y1,y2,zoomAndPan",!0),B=b.extend({},y,A,z);!function(a){var b;if(!a.document||!a.document.implementation)throw m("noinert","Can't create an inert html document");b=a.document.implementation.createHTMLDocument("inert");var c=b.documentElement||b.getDocumentElement(),d=c.getElementsByTagName("body");if(1===d.length)l=d[0];else{var e=b.createElement("html");l=b.createElement("body"),e.appendChild(l),b.appendChild(e)}}(a),b.module("ngSanitize",[]).provider("$sanitize",d),b.module("ngSanitize").filter("linky",["$sanitize",function(a){var c=/((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i,d=/^mailto:/i,f=b.$$minErr("linky"),g=b.isString;return function(h,i,j){function k(a){a&&q.push(e(a))}function l(a,c){var d;if(q.push("<a "),b.isFunction(j)&&(j=j(a)),b.isObject(j))for(d in j)q.push(d+'="'+j[d]+'" ');else j={};!b.isDefined(i)||"target"in j||q.push('target="',i,'" '),q.push('href="',a.replace(/"/g,"&quot;"),'">'),k(c),q.push("</a>")}if(null==h||""===h)return h;if(!g(h))throw f("notstring","Expected string but received: {0}",h);for(var m,n,o,p=h,q=[];m=p.match(c);)n=m[0],m[2]||m[4]||(n=(m[3]?"http://":"mailto:")+n),o=m.index,k(p.substr(0,o)),l(n,m[0].replace(d,"")),p=p.substring(o+m[0].length);return k(p),a(q.join(""))}}])}(window,window.angular),function(){"use strict";angular.module("gbBlog",["gbBlog.core","gbBlog.blog","gbBlog.home","gbBlog.layout","gbBlog.projects","gbBlog.resume","gbBlog.community","gbBlog.contract"])}(),function(){"use strict";function a(a,b,c){c.otherwise("/site/home"),a.html5Mode({enabled:!1,requireBase:!1})}angular.module("gbBlog").config(a),a.$inject=["$locationProvider","$stateProvider","$urlRouterProvider"]}(),function(){"use strict";angular.module("gbBlog.core",["ngSanitize","ui.router"])}(),function(){"use strict";function a(){function a(a){var c=b.projects[a];return c}var b={};return b.tagLine="Confident and respected web developer with experience in front and back end development.  Conceptualized, developed and deployed over 10 web sites built using a mix of languages, libraries and frameworks.  Knowledgeable about implementations of different databases and benefits of using specific technologies to solve complex problems.  Active in the open source and tech communities, both of which I feel very passionate about.",b.tagline2="SFUSD Educator transitioning to a web application developer & tech inclusion advocate. I am seeking a role where I can build upon skills and experiences gained as an educator, while dedicating myself to continuously learning and excelling in a web developer career.",b.name="Bedford Franklin Williamson IV",b.location="San Francisco",b.email="goodbedford@gmail.com",b.website="http://www.goodbedford.com",b.occupation="Front End Developer",b.img=["src/assets/images/gb-logos/gblogo40.png"],b.workExperience=[{company:"Oakland Digital & Literacy Center (Google.org Non-Profit Recipient)",title:"Front End Developer",location:"1224 Harrison St. Oakland, CA 94612",phone:"510-435-2945",url:"http://oaklanddigital.org/",description:["Create UI wireframes & documentation for BRIDGEGOOD.com.","Design & Implement responsive site UI utilizing HTML5, CSS, Bootstrap, Angular 1.x, JSON.","Manage version control with Git software."],timePeriod:{start:"05-2016",end:"current"},supervisor:"Shaun Tai"},{company:"General Assembly",title:"Workshop Instructor",location:"225 Bush St. Fl. 5, San Francisco, CA 94104",phone:"415-592-6885",url:"https://generalassemb.ly/",description:["Develop lessons for Intro to Javascript that prepare students for making interactive web apps.","Teach Javascript & Jquery to ensure understanding of programming fundamentals.","Foster General Assembly culture and team building to produce a vigorous working & learning environment."],timePeriod:{start:"04-2016",end:"current"},supervisor:"Anya Vo"},{company:"General Assembly",title:"Teaching Assistant",location:"225 Bush St. Fl. 5, San Francisco, CA 94104",phone:"415-592-6885",url:"https://generalassemb.ly/",description:["Advocate and Mentor 30 Jr. Web Developers.","Develop materials for front end development lessons that ensure mastery of materials.","Foster General Assembly culture and team building to produce a vigorous working & learning environment.","Recruit & Interview applicants seeking to enroll in Web Development Immersive programs."],timePeriod:{start:"09-2015",end:"12-2015"},supervisor:"Alexandra Pisano"},{company:"San Francisco Unified School District",title:"Transition Specialist",location:"555 Franklin St. San Francisco, CA 94102",phone:"415-241-3030",url:"http://www.sfusd.edu/",description:["Provided specialized employment training to 350+ people with disabilities.","Maintain Moodle CMS website, Microsoft Access database and social media.","Managed 20 internship training sites that provided the skills to successfully transition people with disabilities to meaningful employment.","Filed monthly and annual reports and budgets up to $200,000."],timePeriod:{start:"08-2007",end:"05-2015"},supervisor:"N/A"}],b.education=[{school:"General Assembly",url:"https://generalassemb.ly/",description:["Completed 12 week course of intense software engineering.","Design rich web applications utilizing REST APIs, HTML, CSS, JS, Node, Ruby, Rails & modern build process.","Utilized pair programming and individual study for rapid advancement in a short period of time."],location:"225 Bush St. Fl. 5, SF CA 94104",major:"Advanced Web Application Development and Front End Engineering",degree:"Full Stack Web Developer Certificate",timePeriod:{start:"06-2015",end:"09-2015"}},{school:"City College of San Francisco",url:"http://www.ccsf.edu/",description:["Develop and maintain web sites according to industry standards","Add interactivity to web pages via scripting programs and/or server-side technologies","Recognize and use appropriate Web 2.0 technologies to promote or enhance the work environment"],location:"50 Phelan Ave, San Francisco, CA 94112",major:"Computer Science",degree:"Web Site Development Techniques",timePeriod:{start:"month-year",end:"month-year"}},{school:"Robert Morris University",url:"http://www.rmu.edu/",description:["Business Administration","Intro to Information Systems","Business Math"],location:"6001 University Blvd, Moon, PA 15108",major:"Management Information Systems",degree:"Associate Degree in Business Administration",timePeriod:{start:"month-year",end:"month-year"}}],b.projects=[{title:"Tic Tac Toe",url:"https://goodbedford.github.io/tic/",repo:"https://github.com/goodbedford/tic",description:"I made a tic tac toe game in one day. I spent most of the time on the colors and animations.",stack:"HTML5, CSS3, SASS, Javascript, RWD, NPM, Gulp",role:"Front End Developer",img:["src/assets/images/projects/tictac/mobile-min.png","src/assets/images/projects/tictac/rwd-tictac-min.png"],date:"08-2016"},{title:"Foodie",url:"https://goodbedford.github.io/food/",repo:"https://github.com/goodbedford/food",description:"Responsive Food Blog demo project: inspired by http://foodsense.is/",stack:"HTML, CSS, SASS, Javascript, Jquery, RWD, NPM, Gulp, Karma, Jasmine",role:"Front End Developer",img:["src/assets/images/projects/foodie/foodie-min.png","src/assets/images/projects/foodie/rwd-foodie-min.png"],date:"08-2016"},{title:"Profile Card",url:"https://codepen.io/goodbedford/pen/ezzGXN",repo:"https://codepen.io/goodbedford/pen/ezzGXN",description:"Colorful Profile Card",stack:"HTML5,CSS3, Javascript, SASS",role:"Front End Developer",img:["src/assets/images/projects/codepen/card2-bem-min.png","src/assets/images/projects/codepen/card2-bem-min.png"],date:"06-2016"},{title:"Awwwards-clone",url:"https://goodbedford.github.io/awards/",repo:"https://github.com/goodbedford/awards",description:"This site is an responsive demo clone of http://www.awwwards.com/",stack:"HTML5,CSS3, Javascript, SASS, RWD, Gulp",role:"Front End Developer, I looked at Awwwards.com and made a clone of it. Pay attention to the responsive layout created with flexbox.",img:["src/assets/images/projects/awards/main-page-min.png","src/assets/images/projects/awards/rwd-layout-min.png"],date:"06-2016"},{title:"BRIDGEGOOD.com",url:"https://bridgegood.com/",repo:"",description:"Responsive HTML5 app that connects early stage designers with professional opportunities.",stack:"REST API, HTML, CSS, JavaScript, RWD, JSON, Angular 1.x, Rails, Heroku, PostgreSQL",role:"Front-End redesign of desktop and mobile layout",img:["src/assets/images/projects/bridgegood/rwd-bridgegood-min.png","src/assets/images/projects/bridgegood/bridgegood-screenshot-min.png"],date:"05-2016"},{title:"#OOTD (outfit of the day)",url:"https://ootd-app.herokuapp.com/#/",repo:"https://github.com/goodbedford/ootd2016",description:"Responsive Mobile First application designed to save outfits into a personal lookbook. Demonstrates proficient use of third-party APIs (Instagram) and effective code.NOTE:*Instagram has changed its API Policy so this Errors.",stack:"REST API, HTML, CSS, JavaScript, RWD, JSON, Angular 1.x, Heroku, MongoDB(NoSql), Node & Express",role:"Conceptualization, Front-End & Back-End Development",img:["src/assets/images/projects/ootd2016/ootd2016-screenshot-min.png","src/assets/images/projects/ootd2016/ootd2016-screenshot-min.png"],date:"03-2016"},{title:"Goodbedford.com",url:"http://www.goodbedford.com/",repo:"https://github.com/goodbedford/gbBlog2016",description:"Responsive Portfolio and Blog showcasing present and past projects.",stack:"HTML5, CSS, Javascript, Jquery, Bootstrap, Sass, RWD, Karma, Grunt, Jasmine, NPM, Emmet, Sketch, Webstorm",role:"Conceptualization, Front-End & Back-End Development, Testing",img:["src/assets/images/projects/gbBlog/projects-page-min.png","src/assets/images/projects/gbBlog/projects-page-min.png"],date:"02-2016"},{title:"Duplicate Finder",url:"http://duplicatefinder.bitballoon.com/",repo:"https://github.com/goodbedford/Finder",description:"Duplicate Finder is a small demonstration of finding matching strings in another string algorithm.",stack:"Angular, Material Design, UI Router, Bower, Emmet, Webstorm, BitBallon",role:"Conceptualization & Front-End Development",img:["src/assets/images/projects/duplicateFinder/duplicate-finder-min.png","src/assets/images/projects/duplicateFinder/duplicate-finder-min.png"],date:"01-2016"},{title:"Movie Rating Stars",url:"http://gb-movie-rating.bitballoon.com/",repo:"https://github.com/goodbedford/ratings",description:"UI demo of movie rating stars",stack:"HTML5, CSS, Javascript, Jquery, Grunt, NPM, Webstorm, Bitballon",role:"Conceptualization, Front-End Development",img:["src/assets/images/projects/movieRatingStars/star-rating-min.png","src/assets/images/projects/movieRatingStars/star-rating-min.png"],date:"01-2016"},{title:"atCon",url:"https://atcon.herokuapp.com/",repo:"https://github.com/sswbelser/atCon",description:"A Rich web application built for creating one-off events similar to Eventbrite.",stack:"REST API, HTML, CSS, JavaScript, JSON, Heroku, Ruby, Ruby on Rails, PostgreSQL, AWS S3",role:"Conceptualization, Git Management & Back-End Development(Routing & Modeling)",img:["src/assets/images/projects/atcon/atCon-screenshot-min.jpg","src/assets/images/projects/atcon/atCon-screenshot-min.jpg"],date:"08-2015"},{title:"Enrollment Data Viz",url:"https://enrollment-data.herokuapp.com/",repo:"https://github.com/goodbedford/enrollment",description:"A Data visualization projectSpec showcasing various chart types including animated line, bar, pie, donut and small multiples.",stack:"C3, D3, HTML, CSS, Javascript, Node, Express & Heroku",role:"Conceptualization, Front-End & Back-End Development",img:["src/assets/images/projects/enrollment/Enrollment-linegraph-screenshot-min.png","src/assets/images/projects/enrollment/Enrollment-small-multiples2-min.png"],date:"12-2015"}],b.skills={languages:"JavaScript, Ruby, HTML, CSS, Markdown",libraries:"Jquery, Bootstrap, Sass, Underscore, Templating, C3, D3, Rspec, Jasmine, Mocha",frameworks:"Angular 1.x, Node, Express, Rails",database:"MongoDB, Mongoose, PostgreSQL, MySQL, NoSQL",technologies:"Slack, Heroku, Trello, GitHub, REST API, JSON, Karma, Grunt, RWD, HTTP, MVC, AJAX, UI, UX,Bower, NPM, Emmet",personal:"Team Building, Communication, Goal-Setting, Leadership, Conflict Resolution, Organization"},b.community=[{title:"Node School/SF/OAK",url:"http://nodeschool.io/sanfrancisco/",img:"src/assets/images/community/nodeschool-screenshot.png",description:"NodeSchool is for people totally new to programming, as well as experienced programmers looking to try a new language or skillset. Knowing some JavaScript will help, but is not necessary."},{title:"SF HTML5 Meet Up",url:"http://www.meetup.com/sfhtml5/",img:"src/assets/images/community/sfhtml5-screenshot.png",description:"Welcome to the San Francisco HTML5 Developer Group: the largest Web Development Meetup in the world! We host monthly events in San Francisco with presentations by the industry's leading experts in cutting-edge web technologies. Past speakers include superstars like Paul Irish, Parisa Tabriz, Jen Simmons, Bruce Lawson, Steve Souders, Divya Manian, Brian Leroux, Pamela Fox, Christian Heilmann, Rachel Nabors, and many more. We also record all of the talks so you can watch the videos later. Check out videos from our past events at bit.ly/sfhtml5videos."},{title:"General Assembly",url:"https://generalassemb.ly/",img:"src/assets/images/community/general-assembly-screenshot.png",description:"At General Assembly, we are creating a global community of individuals empowered to pursue work they love, by offering full-time immersive programs, long-form courses, and classes and workshops on the most relevant skills of the 21st century – from web development and user experience design, to business fundamentals, to data science, to product management and digital marketing."},{title:"Developer Week 2016",url:"http://www.developerweek.com/about/",img:"src/assets/images/community/HiringMixer-DeveloperWeek2016-screenshot.png",description:"DeveloperWeek 2016 is San Francisco’s largest one-week tech event series with over 60 week-long events including the DeveloperWeek 2016 Conference & Expo, the DeveloperWeek Hackathon (1,000+ attendees), Official Hiring Mixer (800+ hirable developers and 50+ hiring companies), and dozens of city-wide partner events. "},{title:"TechUP 2016",url:"https://www.facebook.com/lesbianswhotech/posts/1253203418026374",img:"src/assets/images/community/techup-hiring.png",description:"TechUP connects diverse tech talent with companies who believe diversity is an advantage, and that inclusive teams are stronger, smarter, and better.TechUP intentionally recruits badass, underrepresented and talented tech professionals with a variety of skills. We especially seek women, people of color, LGBTQ individuals, and people who live with a disability.TechUP Career Fair Hosted @Twitter HQ Feb 27th"}],b.getDetail=a,b}angular.module("gbBlog.core").factory("BioService",a),a.$inject=[]}(),function(){"use strict";angular.module("gbBlog.blog",[])}(),function(){"use strict";function a(a,b){a.state("site.blog",{url:"/goodblog",views:{content:{controller:"BlogController",controllerAs:"blog",templateUrl:"src/components/blog/blog.tpl.html"}}}).state("site.blogDetails",{url:"/goodblog/:blogId",views:{content:{controller:"BlogDetailsController",controllerAs:"blogDetails",templateUrl:"src/components/blog/blogDetails.tpl.html"}}})}angular.module("gbBlog.blog").config(a),a.$inject=["$stateProvider","$urlRouterProvider"]}(),function(){"use strict";angular.module("gbBlog.home",[])}(),function(){"use strict";function a(a,b){a.state("site.home",{url:"/home",views:{content:{controller:"HomeController",controllerAs:"home",templateUrl:"src/components/home/home.tpl.html"}}})}angular.module("gbBlog.home").config(a),a.$inject=["$stateProvider","$urlRouterProvider"]}(),function(){"use strict";angular.module("gbBlog.projects",[])}(),function(){"use strict";function a(a,b){a.state("site.projects",{url:"/projects",views:{content:{controller:"ProjectController",controllerAs:"project",templateUrl:"src/components/projects/projects.tpl.html"}}}).state("site.details",{url:"/projects/:projectId",views:{content:{controller:"ProjectDetailsController",controllerAs:"projectDetails",templateUrl:"src/components/projects/projectDetails.tpl.html"}}})}angular.module("gbBlog.projects").config(a),a.$inject=["$stateProvider","$urlRouterProvider"]}(),function(){"use strict";angular.module("gbBlog.resume",[])}(),function(){"use strict";function a(a,b){a.state("site.resume",{url:"/resume",views:{content:{controller:"ResumeController",controllerAs:"resume",templateUrl:"src/components/resume/resume.tpl.html"}}})}angular.module("gbBlog.resume").config(a),a.$inject=["$stateProvider","$urlRouterProvider"]}(),function(){"use strict";angular.module("gbBlog.community",[])}(),function(){"use strict";function a(a,b){a.state("site.community",{url:"/community",views:{content:{controller:"ResumeController",controllerAs:"community",templateUrl:"src/components/community/community.tpl.html"}}})}angular.module("gbBlog.community").config(a),a.$inject=["$stateProvider","$urlRouterProvider"]}(),function(){"use strict";angular.module("gbBlog.contract",[])}(),function(){"use strict";function a(a,b){a.state("site.contact",{url:"/contact",views:{content:{controller:"ResumeController",controllerAs:"contact",templateUrl:"src/components/contact/contact.tpl.html"}}})}angular.module("gbBlog.contract").config(a),a.$inject=["$stateProvider","$urlRouterProvider"]}(),function(){"use strict";function a(a){var b=this;b.blogs=a.query(),b.placeCssHeader=function(a,b,c){return a===b.length-1?"":c},b.placeCssHeaderNo1st=function(a,b,c){return 0===a?"":c}}angular.module("gbBlog.blog").controller("BlogController",a),a.$inject=["BlogService"]}(),function(){"use strict";function a(a,b){function c(){var c=a.blogId;d.blog=b.getDetails(c),console.log("blog details controllerrrr")}var d=this;c()}angular.module("gbBlog.blog").controller("BlogDetailsController",a),a.$inject=["$stateParams","BlogService"]}(),function(){"use strict";function a(){function a(){return[{title:"Another Career Fair",date:"02-16-2016",author:"Goodbedford",content:{thanks:"Thank you, Developer Week as well as the person who posted the promo code for us at GA. I appreciate you. Also to Sally from Target, we shared a table together and charged our cell phones. ",body:"<a class='blog-detail__link' ng-href='http://www.developerweek.com/'>Developer Week 2016</a> was fun enough to go. I saw a lot of alumni and they mentioned a few good talks. My buddy Angelo thought <a class='blog-detail__link' ng-href='http://www.benmvp.com/'>Ben Ilegbodu</a> was particularly awesome. I will have to look for his talk online. It was about <a class='blog-detail__link' ng-href='https://babeljs.io/docs/learn-es2015/'>es6 or es2015</a>, you be the judge. I was enjoying meeting new people but was somewhat sensitive to the banging house music and the crowds were a little scary. I can only image how it was for someone with more sensitivity to crazy noise and overcrowded spaces. I am going to <span class='blog-detail__highlight'>another career fair</span> TechUP in two weeks. I already like the setup, all the job seekers have time slots. I assume this will help manage the crowds. That's what you call great UX. Almost as good as this <a class='blog-detail__link' ng-href='https://image-store.slidesharecdn.com/bc9d69bc-a389-4117-af2f-b3ac8f23e3b8-original.jpeg'>image.</a>"},img:"src/assets/images/blog-images/2016-02-16/resume-02.svg"},{title:"Whole new dimension to being a web developer",date:"07-29-2015",author:"Goodbedford",content:{thanks:"I must do a quick thank you to all my friends and family. This article is dedicated to some local organizers and Yassin at <a class='blog-detail__link' ng-href='http://www.meetup.com/Ionic-SF/'>SF Ionic Meet Up</a> and Ruben from <a class='blog-detail__link' ng-href='https://codeclass.io/#/'>Code.io</a>. Thanks for a great event.",body:"I got stickers from Max from <a class='blog-detail__link' ng-href='http://drifty.com/'>Drifty</a>. I thought that was coolness. I know I’m new to the game but I hope it last forever. I hope to always be inspired and humbled by our work. The programming community is large and small much like San Francisco and the Bay Area. I was at a meet up at <a class='blog-detail__link' ng-href='http://www.hackreactor.com/program'>HR</a> for <a class='blog-detail__link' ng-href='http://ionicframework.com/getting-started/'>Ionic</a> with my instructor from <a class='blog-detail__link' ng-href='https://generalassemb.ly/education/web-development-immersive' >GA</a>. We got to hear some great announcements Ionic Market Place and Ionic 2. It seems like version 2 is right on time for <a class='blog-detail__link' ng-href='https://angular.io/docs/js/latest/guide/'> Angular 2</a>. Ionic 2 had mostly the same components with enhanced physics and improved performance. Max didn’t give a hard timetable but hinted about shorter Alpha and Beta timelines. I think Ionic is powerful because it brings a <span class='blog-detail__highlight'>whole new dimension to being a web developer</span>. <a class='blog-detail__link' ng-href='http://johnpolacek.github.io/scrolldeck.js/decks/responsive/'> Mobile First</a> developers can actually put apps up on <a class='blog-detail__link' ng-href='https://itunes.apple.com/us/app/apple-store/id375380948?mt=8'>Apple Store </a>and <a class='blog-detail__link' ng-href='https://play.google.com/store/apps?hl=en'> Google Play</a>. That opens up so many possibilities.  I need to work on an Ionic projectSpec and give it a spin. I also want to give a shot out to the opening speaker <a class='blog-detail__link' ng-href='https://blog.nraboy.com/'> Nic Raboy</a>. He gave a live coding demo of an Ionic app. He also spoke about an interesting NoSql database <a class='blog-detail__link' ng-href='http://www.couchbase.com/'> Couchbase DB</a>. He said they are currently looking to <a class='blog-detail__link' ng-href='http://www.couchbase.com/careers'>hire</a> but what I really found interesting was his <a class='blog-detail__link' ng-href='https://blog.nraboy.com/2015/07/my-first-year-of-blogging-and-the-stats-around-it/'> blog</a>. He has some really tight posts. All in all a good day."},img:"src/assets/images/blog-images/2015-07-29/telescope.svg"},{title:"Code of Conduct",date:"06-28-2015",author:"Goodbedford",content:{thanks:"I would like to give thanks to everyone who helped me this week. In no particular order Rich and Steve from <a class='blog-detail__link' ng-href='http://nodeschool.io/sanfrancisco/'>Node School SF</a>.",body:"I loved when Rich read the <a class='blog-detail__link' ng-href='https://github.com/nodeschool/sanfrancisco/blob/gh-pages/code-of-conduct.md'>code of conduct</a> for each person who arrived late. The <span class='blog-detail__highlight'>code of conduct</span> made me feel welcomed and set the tone for a safe environment to learn. Traffic was crazy this weekend. It's Pride weekend and the Supreme Court decision was right on time. I have to thank <a class='blog-detail__link' ng-href='https://github.com/smallhaxe'>@smallhaxe</a> for the welcome. We had a few talks about node and file structures. My classmates are awesome and the instructors a just wonderful people. This was my first week of bootcamp and it was amazing how much information we that is floating out there. Here are a few resources that helped me. <a class='blog-detail__link' ng-href='https://developer.mozilla.org/en-US/'>MDN</a> great for Javascript. <a class='blog-detail__link' ng-href='http://getbootstrap.com/css/'>Bootstrap</a> great for CSS."},img:"src/assets/images/blog-images/2015-06-28/bullhorn.svg"},{title:"Add these details to the plan",date:"05-29-2015",author:"Goodbedford",content:{thanks:"I would like to give thanks to Joe Blau and Maurice Cherry. To all the listeners and my family. I am inspired and filled with creation.",body:"I was listening to this podcast and I was like, Yo I really like what Joe is saying. I  can relate to his hustle and fascination. The curiosity and amazement of riding the wave of intense education. A wealth of experience from all angles of his life. It made me think of a lot of things. One of which was to keep at the blogcast and be thankful to those that helped me. I find it honestly refreshing to me when a person gives some acknowledgement to whom they grew and fellowshipped with. Which reminds me to <span class='blog-detail__highlight'>add these details to my plan</span>.<br /><a class='blog-detail__link' ng-href='https://joeblau.com/'>Joe Blau</a> was on <a class='blog-detail__link' ng-href='http://revisionpath.com/'>Revision Path</a> podcast. <a class='blog-detail__link' ng-href='http://revisionpath.com/?s=joe+blau'>Episode 65</a>"},img:"src/assets/images/blog-images/2015-05-29/glasses-02.svg"},{title:"Accepted",date:"05-08-2015",author:"Goodbedford",content:{thanks:"I would like to thank my family and friends for their help and encouragement to pursue my dreams of being a developer",body:"I got <span class='blog-detail__highlight'>accepted</span> into a Web Development Immersive Bootcamp.I am glad my previous work has paid off. Now, as I look into the future there is so much further to go. I could be daunting when thinking about where to begin.  So I will have to make a list of goals. In my school, I am going to  learn Javascript and Ruby.  I will also learn the Rails, Angular, Express, Node, Mongo DB, PostgreSql, and testing in Mocha.  I am also interested in Famous.js, React.js and ES6 compilers like Babel. I don’t want to get stuck in liking everything new and not mastering the current. It will be a twelve week intensive program. I need to have a job at the other end.  I have quit both my jobs making over let's just say 75 grand to go back to school. I am honestly giving it my best chance. Wish me luck. "},img:"src/assets/images/blog-images/2015-05-08/tictac-02.svg"},{title:"Hacker School",date:"01-29-2015",author:"Goodbedford",content:{thanks:"This is a relaunch of my personal blog. I would like to remember to thank people who have added to my growth. So, I say thanks!",body:"Today I went to my <span class='blog-detail__highlight'>hacker school</span>. I said I can do this, the people are there. The craziest thing about it, was a good feeling. Just walking in there I knew I could just bring a lot to the cohort. I am already envisioning them. A few good thoughts came to me, why doesn't this text editor not have a dictionary/thesaurus? Not that thought but I walked in and the front was very low key. I missed the first time up the block. I liked that quality. The thing that got me most, I saw people I saw on the internet. Amazing. I mean I saw someone who answered the online group video conference question. Peace, I gotta go put in work. "
},img:"src/assets/images/blog-images/2015-01-29/computer-03.svg"}]}function b(a){var b=c.query(),d=b[a];return d}var c={query:a};return c.getDetails=b,c}angular.module("gbBlog.blog").factory("BlogService",a),a.$inject=[]}(),function(){"use strict";function a(a,b,c){var d=a.slice(b,c);return d}angular.module("gbBlog").filter("greaterThan",a),a.$inject=[]}(),function(){"use strict";function a(a,b){var c=this;c.bio=a,c.test="beddy",c.logos=b.query()}angular.module("gbBlog.home").controller("HomeController",a),a.$inject=["BioService","LogoService"]}(),function(){"use strict";function a(a){var b=this;b.bio=a}angular.module("gbBlog.projects").controller("ProjectController",a),a.$inject=["BioService"]}(),function(){"use strict";function a(a,b){function c(){var c=a.projectId;d.project=b.getDetail(c),console.log("details controllerrrr")}var d=this;c()}angular.module("gbBlog.projects").controller("ProjectDetailsController",a),a.$inject=["$stateParams","BioService"]}(),function(){"use strict";function a(a){var b=this;b.bio=a,b.placeCssHeader=function(a,b,c){return a===b.length-1?"":c},b.placeCssHeaderNo1st=function(a,b,c){return 0===a?"":c}}angular.module("gbBlog.resume").controller("ResumeController",a),a.$inject=["BioService"]}(),function(){"use strict";angular.module("gbBlog.layout",[])}(),function(){"use strict";function a(a,b){a.state("site",{url:"/site","abstract":!0,views:{"":{templateUrl:"src/layout/layout.tpl.html"},"nav@site":{controller:"NavController",controllerAs:"nav",templateUrl:"src/layout/nav.tpl.html"},"footer@site":{controller:"LogoController",controllerAs:"logo",templateUrl:"src/layout/logoFooter.tpl.html"}}})}angular.module("gbBlog.layout").config(a),a.$inject=["$stateProvider","$urlRouterProvider"]}(),function(){"use strict";function a(a){var b=this;b.logos=a.query()}angular.module("gbBlog.layout").controller("LogoController",a),a.$inject=["LogoService"]}(),function(){"use strict";function a(){var a={};return a.query=function(){return[{name:"HTML",img:"src/assets/images/icons/html5.png",type:"Language"},{name:"CSS",img:"src/assets/images/icons/css.png",type:"Language"},{name:"Javascript",img:"src/assets/images/icons/javascript.png",type:"Language"},{name:"Ajax",img:"src/assets/images/icons/ajax.png",type:"Technology"},{name:"Angular 1.x",img:"src/assets/images/icons/angular.png",type:"Framework"},{name:"Bootstrap",img:"src/assets/images/icons/bootstap.jpeg",type:"Framework"},{name:"Bower",img:"src/assets/images/icons/bower.png",type:"Technology"},{name:"C3.js",img:"src/assets/images/icons/c3.jpeg",type:"Library"},{name:"D3.js",img:"src/assets/images/icons/d3.jpeg",type:"Library"},{name:"Emmet",img:"src/assets/images/icons/emmet.png",type:"Technology"},{name:"Express",img:"src/assets/images/icons/express.png",type:"Framework"},{name:"Github",img:"src/assets/images/icons/github.png",type:"Technology"},{name:"Grunt",img:"src/assets/images/icons/grunt.png",type:"Library"},{name:"Heroku",img:"src/assets/images/icons/heroku.png",type:"Technology"},{name:"Jasmine",img:"src/assets/images/icons/jasmine.png",type:"Library"},{name:"Jquery",img:"src/assets/images/icons/jquery.png",type:"Library"},{name:"JSON",img:"src/assets/images/icons/jsonlogo.png",type:"Technology"},{name:"Karma",img:"src/assets/images/icons/karma.png",type:"Library"},{name:"Mocha",img:"src/assets/images/icons/mocha.png",type:"Library"},{name:"MongoDB",img:"src/assets/images/icons/mongoDB.png",type:"Database"},{name:"Mongoose",img:"src/assets/images/icons/mongoose.png",type:"Library"},{name:"SqLite",img:"src/assets/images/icons/sqlite.jpeg",type:"Database"},{name:"Node",img:"src/assets/images/icons/node.png",type:"Langauge"},{name:"NPM",img:"src/assets/images/icons/npm.png",type:"Technology"},{name:"PostgreSQL",img:"src/assets/images/icons/postgresql.png",type:"Database"},{name:"Ruby on Rails",img:"src/assets/images/icons/rails.jpeg",type:"Framework"},{name:"Rspec",img:"src/assets/images/icons/rspec.jpeg",type:"Library"},{name:"Ruby",img:"src/assets/images/icons/ruby.jpeg",type:"Language"},{name:"Slack",img:"src/assets/images/icons/slack.png",type:"Technology"},{name:"Underscore",img:"src/assets/images/icons/underscore.png",type:"Library"},{name:"Trello",img:"src/assets/images/icons/trello.png",type:"Technology"}]},a}angular.module("gbBlog.layout").factory("LogoService",a),a.$inject=[]}(),function(){"use strict";function a(){var a=this;a.isClosed=!0}angular.module("gbBlog.layout").controller("NavController",a),a.$inject=[]}();
